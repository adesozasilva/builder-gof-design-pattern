...
- Singleton - It is responsible for restricting only one instance of a given object from determinated class. **Usage Examples** When it is necessary to ensure that there is only one object of a class.
